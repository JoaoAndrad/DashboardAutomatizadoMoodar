...
class ImportService :
    ...
    def start_import (self ,upload_path :str ,job_id :str ,log_append_fn ,*,headless :bool =True ,minimized :bool =False ,company_name :str ='',browser_session_id :Optional [str ]=None ,import_type :str ='auto')->str :
