...
async def start_import (payload :Dict [str ,Any ]):
    ...
    service .start_import (path ,public_job_id ,append_fn ,headless =headless ,minimized =minimized ,company_name =company_name ,company_id =company_id ,browser_session_id =browser_session_id ,import_type =import_type )
